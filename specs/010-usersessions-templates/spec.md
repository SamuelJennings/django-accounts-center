...
- Screenshots are required per Constitution Principle XIII (Multi-Viewport Screenshot Coverage); pytest-playwright screenshot tests covering 2 page states × 3 viewports = 6 PNGs are written as part of this feature and live in the root `screenshots/` directory (states: multiple-sessions, single-session).
