...
- **Button** → `c-button`: Maps submit buttons to primary style, others to secondary
- **Panel** → `c-card`: Account panels use DAC card components
...
- **Provider** → Social login buttons using `c-button`
